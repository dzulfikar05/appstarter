        ...
        <ul class="navbar-nav d-none d-lg-flex ms-3">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu " aria-labelledby="resourcesDropdown">
                    <a class="menu-role d-none dropdown-item  {{ set_active('role') }}" href="role"><i class="align-middle me-1"
                            data-feather="check-square"></i>
                        Role</a>
                    <a class="menu-user d-none dropdown-item  {{ set_active('user') }}" href="user"><i class="align-middle me-1"
        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="dropdown-divider"></div>
                    <form action="javascript:onLogout(this)" method="post" id="form_logout" name="form_logout"
                        autocomplete="off">
                        @csrf
...
<script>
    ...
    $(() => {
        ...
        if (image_pp != '') {
            ...
            $('#pp_user').attr('src', 'assets/user.png');
        }
    })
</script>
